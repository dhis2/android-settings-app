...
test('The list has the correct ids', () => {
    ...
    const desiredResult = ["Yf6UHoPkdS6", "ycd5BzF8jYw", "fqs276KXCXi", "TiOkbpGEud4", "ham2eIDJ9k6"]
...
test('The result list shows duplicated ids', () => {
    ...
    const desiredResult = ["Yf6UHoPkdS6", "ycd5BzF8jYw", "fqs276KXCXi", "TiOkbpGEud4", "ham2eIDJ9k6", "Yf6UHoPkdS6"]
